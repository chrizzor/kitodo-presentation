		...
		if ($status == 'new') {
			...
			switch ($table) {
				...
				case 'tx_dlf_metadata':
					...
					if (isset($fieldArray['metastored']) && $fieldArray['metastored'] == 0 && !isset($fieldArray['is_listed'])) {
						...
						if ($GLOBALS['TYPO3_DB']->sql_num_rows($result)) {
							...
							list ($fieldArray['metastored']) = $GLOBALS['TYPO3_DB']->sql_fetch_row($result);
